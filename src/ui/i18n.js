export const copy = {
  mn: {
    ...
    roomConnected: 'ӨРӨӨНД ХОЛБОГДСОН', roomConnecting: 'ӨРӨӨНД ХОЛБОЖ БАЙНА', pick: 'СОНГОНО', ready: 'БЭЛЭН', notJoined: 'ОРООГҮЙ',
    ...
    locking: 'Сонголтыг серверт баталгаажуулж байна…', bothReady: 'Хоёулаа бэлэн · тулаан автоматаар эхэлнэ',
    practicePick: 'Бэлтгэлийн баатраа сонго', practiceStart: 'Бэлтгэл эхэлж байна',
    autoStart: 'Start товч шаардлагагүй · хоёулаа сонгомогц автоматаар эхэлнэ', retry: 'Дахин холбох',
  ...
  en: {
    ...
    roomConnected: 'ROOM CONNECTED', roomConnecting: 'CONNECTING TO ROOM', pick: 'PICKING', ready: 'READY', notJoined: 'NOT JOINED',
    ...
    locking: 'Confirming your pick with the server…', bothReady: 'Both ready · battle starts automatically',
    practicePick: 'Choose a hero for practice', practiceStart: 'Starting practice',
    autoStart: 'No Start button needed · battle begins when both players pick', retry: 'Reconnect',
